...
const playSong = ev => {
    ...
    //const songNumber = Number(ev.currentTarget.dataset.index);
    //console.log(tracks[songNumber]);
    //console.log(tracks[songNumber].preview_url);
    //document.querySelector('#audio-source').src = tracks[songNumber].preview_url;
